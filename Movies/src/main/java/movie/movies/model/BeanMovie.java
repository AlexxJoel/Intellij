...
public class BeanMovie {
    ...
    public BeanMovie(int id, String name, String description, Date publish_date, String actors, int duration, int ranking, String imageToShow, InputStream imageToInsert, int status) {
        this.id = id;
        this.name = name;
